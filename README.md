...
- Añadí un debounce para que las busquedas por api no lancen requests en cada input change, use un método práctico actualizando los searchParams de la url para comunicar el client component con el parent server component y además mantener el estado y poder compartir la url de busqueda
...
- El cross-tab sync se necesitan los event the storage como comunicar cambios a las tabs del localStorage
- SEO metadata
- Focus styles
- Error handling, añadir quizas diferentes mensajes o Toast components, añadir el error.tsx
- Añadir automatizaciones a las PR o husky para los commits
